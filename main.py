        """
        Data Profiler Vv1a5f
        ====================
        Lightweight ETL component that can validate millions of rows efficiently.
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight ETL component that can validate millions of rows efficiently.")
